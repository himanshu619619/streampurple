                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="dealer_date"class="form-control" placeholder="Enter Dealer From Which Purchased"> <span class="help-block">  <?php echo form_error('dealer_date'); ?></span> </div>
                                                </div>
                                                <!--/span-->
                                                <div class="col-md-6">
                                                    <div class="form-group ">
