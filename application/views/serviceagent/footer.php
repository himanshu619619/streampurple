 <div class="right-sidebar">
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul style="display: none;" class="m-t-20 chatonline">
                                <li><b>Chat option</b></li>
                                <li>
                                    <a href="javascript:void(0)"><img src="<?php echo base_url('assets/user');?>/plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
