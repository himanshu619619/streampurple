              ...
              <div id="home3" class="tab-pane active">
               <div class="col-sm-12">
                ...
                <p class="text-muted m-b-30 font-13"> All bootstrap element classies </p> -->
                 ...
                 <?php echo form_open('serviceagent/account_setting');?>
                    <div align="center">
...
<script type="text/javascript">
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('serviceagent/change_password'); ?>",
    ...
    function get_state(country_id){
     ...
     $.ajax({
             ...
             type  : 'post',
             url  : "<?php echo  base_url('serviceagent/get_states');?>",
    ...
    function get_city(state_id){
      ...
      $.ajax({
             ...
             type  : 'post',
             url  : "<?php echo  base_url('serviceagent/get_cities');?>",
