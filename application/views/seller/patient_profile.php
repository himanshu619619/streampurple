                            ...
                            <div class="user-btm-box">
                                ...
                                <div class="row text-center m-t-10">
                                    <div class="col-md-6 b-r"><strong>Name</strong>
                                        <p><?php echo $patient_profile->fname;?></p>
                                    </div>
                                    <div class="col-md-6"><strong>Phone</strong>
                                        <p><?php echo $patient_profile->mobile; ?></p>
                                    </div>
                                </div>
                                <!-- /.row -->
                                <hr>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <div class="row">
                                 ...
                                 <div class="table-responsive">
                                  <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>Name</th>
                                            <td><?php echo $patient_profile->fname; ?></td>
                                       ...
                                       <!-- <tr>
                                          ...
                                          <tr>
                                            <th>Date Of Birth</th>
                                            <td><?php echo $patient_profile->dob; ?></td>
                                           
                                        </tr>

                                          <tr>
                                            <th>Description</th>
                                            <td><?php echo $patient_profile->description; ?></td>
                              ...
                              <a href="<?php echo base_url('Doctor/patient_booking'); ?>"> <button class="btn btn-info">Back</button></a> 
                            </div>
