                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                   <?php echo form_open_multipart($form_action); ?>
                                       <div class="form-body">
                                            <h3 class="box-title">Upload PPT</h3>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                      <input type="hidden" name="name" value="hello">
                                                        ...
                                                        <input type="file" name="ppt_name" value="" class="form-control" accept=".pptx" required> <span class="help-block"> <?php echo form_error('ppt_name'); ?> </span> </div>
