...
<body > 
 ...
 <li> <a href="<?php echo base_url('admin/Backend/get_results'); ?>" class="waves-effect"><i class="ti-calendar p-r-10"></i> <span class="hide-menu">MCQ Result <span class="fa arrow"></span></span></a>
  ...
  <li> <a href="<?php echo base_url('admin/Backend/ppt_upload'); ?>" class="waves-effect"><i class="ti-calendar p-r-10"></i> <span class="hide-menu">PDF upload <span class="fa arrow"></span></span></a>
 </li>
