          ...
          <div class="white-box">
              ...
              <div class="table-responsive">
                  <table id="testTable" class="display table table-bordered ">
                      ...
                      <tbody>
                      <?php if($pending_question) { ?>
                         <?php $no=1; foreach ($pending_question as $key => $value) { ?>
                          <tr>
                              <td><?php echo $no++; ?></td>
                              ...
                              <td> 
                                ...
                                <a href="<?php echo base_url('admin/backend/pending_question_status/'.$value->status.'/' .$value->message_id);?>"><button class="btn btn-success btn-xs"><i class="fa fa-check " title="Status active"></i>&nbsp;Active&nbsp; </button> </a>
                               </td>
                                <?php }else{?>
                              <td>  <a href="<?php echo base_url('admin/backend/pending_question_status/'.$value->status.'/' .$value->message_id);?>"><button class="btn btn-danger btn-xs"><i class="fa fa-check " title="Status active"></i>&nbsp;Dective </button></td>
                                <?php    }?>
