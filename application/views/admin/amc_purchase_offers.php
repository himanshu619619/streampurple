                         ...
                         <?php $no=1; foreach ($amc_purchase_offers as $key => $value) { ?>
                          <tr>
                              ...
                              <td class="text-nowrap">
                                  ...
                                  <a href="<?php echo base_url('admin/backend/delete_amc_purchase_offers/'.$value->service_id)?>" onclick="return confirm('are you sure');" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close text-danger"></i> </a>
                              </td>
                          </tr>
                          <?php } ?>
                      </tbody>
