    ...
    <div class="detail-banner" style="background-image: url('<?php echo base_url('assets/theme/img/tmp/detail-banner-1.jpg');?>');">
    <div class="container">
...
<div class="container">
        ...
        <div class="detail-gallery">
            <div class="detail-gallery-preview">
                <a href="assets/img/tmp/gallery-1.jpg">
                    <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-1.jpg">
                </a>
            </div>
            ...
            <ul class="detail-gallery-index">
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-1.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-1.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-2.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-2.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-3.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-3.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-4.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-4.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-5.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-5.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-6.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-6.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-7.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-7.jpg" alt="...">
                    </a>
                </li>
                <li class="detail-gallery-list-item active">
                    <a data-target="assets/img/tmp/gallery-8.jpg">
                        <img src="<?php echo base_url('assets/theme');?>/img/tmp/gallery-8.jpg" alt="...">
                    </a>
                </li>
            </ul>
        </div><!-- /.detail-gallery -->
    ...
    <div class="review">
        <div class="review-image">
            <img src="<?php echo base_url('assets/theme');?>/img/tmp/agent-1.jpg" alt="">
        </div><!-- /.review-image -->
    ...
    <div class="review">
        <div class="review-image">
            <img src="<?php echo base_url('assets/theme');?>/img/tmp/agent-2.jpg" alt="">
        </div><!-- /.review-image -->
    ...
    <div class="review">
        <div class="review-image">
            <img src="<?php echo base_url('assets/theme');?>/img/tmp/agent-5.jpg" alt="">
        </div><!-- /.review-image -->
        ...
        <div class="background-white p20">
            <div class="detail-vcard">
                <div class="detail-logo">
                    <img src="<?php echo base_url('assets/theme');?>/img/tmp/pragmaticmates-logo.png">
                </div><!-- /.detail-logo -->
