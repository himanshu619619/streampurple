...
class Frontend extends Front_Controller
{
    ...
    public function index()
    {
        ...
        $data['menu_active'] = 'home';
          $data['banner'] = $this->Customer_model->get_banners_home();

        $data['form_action'] ="Frontend/index";
    ...
    $this->load->library('form_validation');
        ...
        {
            $this->form_validation->set_rules('mobile', 'Mobile', 'trim|required|numeric|min_length[10]|max_length[11]|is_unique[users.mobile]');
        }
        ...
        else
        {
         ...
         $save['user_type']                 = 1;    
            ...
            $this->email->subject('Welcome to StreamPurple');
            $this->email->message('Your Resigration successfully done!');
